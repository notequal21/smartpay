...
$(document).ready(function(){   
    ...
    $('.tel-input').inputmask({mask:"+99999999999", placeholder: "",});
});
...
if (document.querySelector('.form__item')) {
    validateForm('.form__item', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}});
}
